...
import { BusinessesDataFlow } from "@/components/blocks/platform/businesses/BusinessesDataFlow";
import { BusinessesHeroPreview } from "@/components/blocks/platform/businesses/BusinessesHeroPreview";
import { BusinessIndustryCards } from "@/components/blocks/platform/businesses/BusinessIndustryCards";
import {
  businessesHero,
  businessesOutcomes,
  businessesTrust,
  businessesWorkflow,
} from "@/components/blocks/platform/businesses/content";

/**
 * Businesses audience page — structure/copy match to the businesses mockup.
 */
export default function BusinessesPage() {
  return (
    <div className="min-h-screen bg-[#f7f7f8] text-foreground dark:bg-background">
      ...
      <section className="px-8 pb-10 pt-[68px] md:pb-12 md:pt-20">
        <div className="mx-auto max-w-[1100px]">
          ...
          <div className="mt-6 grid items-center gap-8 lg:grid-cols-2 lg:gap-10">
            ...
            <BusinessesHeroPreview />
          </div>
        </div>
      </section>

      {/* Data inputs → intelligence layer */}
        ...
        <div className="mx-auto max-w-[1100px]">
          <div className="mx-auto max-w-[640px] text-center">
            ...
            <p className="mt-2 text-[16px] text-[#6b7280] dark:text-muted-foreground">
              Practical intelligence tailored to how you operate.
            </p>
          </div>
      ...
      <section id="how-it-works" className="scroll-mt-16 px-8 py-10 md:py-12">
        <div className="mx-auto max-w-[1100px]">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4 lg:gap-3">
            {businessesWorkflow.map((step, i) => {
              const Icon = step.icon;
              return (
                <div key={step.title} className="relative">
                  {i < businessesWorkflow.length - 1 ? (
                    <span
      ...
      {/* Trust — single card: headline left | features right */}
      <section className="px-8 py-10 md:py-12">
        <div className="mx-auto max-w-[1100px]">
          <div className="rounded-[16px] border border-[#e8e8ea] bg-[#f3f4f6] px-5 py-6 dark:border-border dark:bg-muted/30 md:px-7 md:py-7">
            <div className="flex flex-col gap-6 lg:flex-row lg:items-stretch lg:gap-0">
              <div className="flex max-w-[280px] shrink-0 items-start gap-3 lg:pr-8">
                ...
                <div>
                  ...
                  <p className="mt-2 text-[13px] leading-relaxed text-[#6b7280] dark:text-muted-foreground">
                    We are designed for security and privacy—so you can use
            ...
            <div className="flex items-start gap-3 md:items-center">
              ...
              <div>
                ...
                <p className="mt-1 text-[13px] leading-relaxed opacity-75">
                  Book a conversation to see how Rimbun can help your business
                  grow.
                </p>
              </div>
            </div>
