    ...
    return (
      <div
        ...
        className={cn(
          ...
          // Completed state: filled primary color (but we won't use this)
          "data-[state=completed]:bg-primary data-[state=completed]:text-primary-foreground",
          // Inactive state: muted background with border
          "data-[state=inactive]:bg-muted data-[state=inactive]:border data-[state=inactive]:border-border",
          className,
        )}
        data-state={state}
        {...props}
      >
        {asChild ? (
          ...
          <>
            ...
            {/* Active state shows as filled circle - no additional indicator needed */}
            {/* Inactive state shows as outlined circle - border is handled by className */}
          </>
        )}
      </div>
    );
