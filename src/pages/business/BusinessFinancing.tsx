...
const BusinessFinancingPage: React.FC<{ customerIdOverride?: string }> = ({
  ...
  return (
    <BusinessWorkspaceShell
      title="Financing"
      description="Facilities, limits, and repayments. Product recommendations stay separate."
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Track known credit lines and loan balances.</CardDescription>
            </CardHeader>
                ...
                onClick={async () => {
                  ...
                  try {
                    await createFacility(ws.customerId, {
                      ...
                      outstandingPrincipal: outstanding ? Number(outstanding) : undefined,
                      availableAmount: available ? Number(available) : undefined,
                ...
                <Card key={f.id}>
                  <CardHeader className="pb-2">
                    ...
                    <CardDescription>
                      ...
                      {f.availableAmount ?? "—"} {f.currency} · source {f.source}
                    </CardDescription>
                  </CardHeader>
                </Card>
              ))
